                                    ...
                                    <ScrollView horizontal={true} style={styles.ScrollHorizontal} showsHorizontalScrollIndicator={false}>
                                        <TouchableWithoutFeedback>
                                            <View style={styles.OptionsActive}>
                                                ...
                                                <Text style={styles.TextOptionsActive}>Todas</Text>
                                            </View>
                                        </TouchableWithoutFeedback>

                                        <TouchableWithoutFeedback>
                                            <View style={styles.Options}>
                                                <Text style={styles.TextOptions}>Pendentes</Text>
                                            </View>
                                        </TouchableWithoutFeedback>
                                        ...
                                        <TouchableWithoutFeedback>
                                            <View style={styles.Options}>
                                                <Text style={styles.TextOptions}>Concluídas</Text>
                                            </View>
                                        </TouchableWithoutFeedback>
                                    </ScrollView>
                                </View>
...
const styles = StyleSheet.create({
    ...
    OptionsActive: {
        ...
        alignItems: "center",
        justifyContent: "center",
        borderBottomWidth: 3,           // 👈 Adiciona uma linha embaixo
        borderBottomColor: Colors.ORANGE, // 👈 Cor da linha
    },
